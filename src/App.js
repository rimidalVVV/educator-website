...
const EducatorWebsite = () => {
  ...
  const renderNavigation = () => (
    <nav className={`nav-container ${isMobile ? 'mobile-nav' : 'desktop-nav'}`}>
  ...
  const renderBanner = (title, content) => (
          ...
          <div className="page-content">
            ...
            <div className="contact-content">
              ...
              <form className="contact-form">
                <input type="text" placeholder={page.form.name} className="form-input" />
                <input type="email" placeholder={page.form.email} className="form-input" />
                <textarea placeholder={page.form.message} className="form-textarea" rows="5"></textarea>
                <button type="submit" className="form-submit">{page.form.send}</button>
              </form>
            </div>
          </div>
        );
